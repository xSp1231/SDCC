...
# for SPLIT_ID in 1
# do
#     for shot in 5 10   # if final, 10 -> 1 2 3 5 10
#     do
#         for seed in 0
#         do
#             CUDA_VISIBLE_DEVICES=2,3,4,5 python main.py --num-gpus 4 --config-file configs/voc/defrcn_fsod_r101_all${SPLIT_ID}_${shot}shot_seed${seed}.yaml --opts CGCL.TAU 0.2 CGCL.COEF 0.5 TEST.PCB_ENABLE True OUTPUT_DIR checkpoints/voc/split${SPLIT_ID}/${shot}shot_CGCL_seed${seed}_finetune
#         done
#     done
# done
